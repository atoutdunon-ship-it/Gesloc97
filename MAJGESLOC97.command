...
echo ""
echo "═══════════════════════════════════════════"
echo "  GESLOC97 · Mise à jour GitHub"
echo "═══════════════════════════════════════════"
echo ""
...
git remote set-url origin "https://github.com/atoutdunon-ship-it/Gesloc97.git"
...
if git diff --cached --quiet; then
  ...
  # ── 2. Commit ────────────────────────────────────────────
  MSG="MAJGESLOC97 — $(date '+%Y-%m-%d %H:%M')"
  git commit -m "$MSG"
...
echo "   → https://atoutdunon-ship-it.github.io/Gesloc97/"
echo ""
